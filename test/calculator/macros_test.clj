...
(deftest exp-macro-test
  (testing "Exponent macro"
    ...
    (test-rounded (exp-macro (- 3 1)) (Math/exp 2))
...
(deftest sin-macro-test
  (testing "Sine macro"
    ...
    (def angle (/ Math/PI 2))
    (test-rounded (sin-macro angle) (Math/sin angle))
    (test-rounded (sin-macro (/ Math/PI 2)) (Math/sin angle))))
...
(deftest sinh-macro-test
  (testing "Sine macro"
    ...
    (def angle (/ Math/PI 2))
    (test-rounded (sinh-macro angle) (Math/sinh angle))
    (test-rounded (sinh-macro (/ Math/PI 2)) (Math/sinh angle))))
...
(deftest cos-macro-test
  (testing "Cosine macro"
    ...
    (def angle (/ Math/PI 2))
    (test-rounded (cos-macro angle) (Math/cos angle))
    (test-rounded (cos-macro (/ Math/PI 2)) (Math/cos angle))))
...
(deftest cosh-macro-test
  (testing "Cosine macro"
    ...
    (def angle (/ Math/PI 2))
    (test-rounded (cosh-macro angle) (Math/cosh angle))
    (test-rounded (cosh-macro (/ Math/PI 2)) (Math/cosh angle))))